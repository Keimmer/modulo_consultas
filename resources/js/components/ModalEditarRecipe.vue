    ...
    <ModalBody>
      ...
      <div class="my-4">
        ...
        <p>
          ...
          Medico Encargado: {{ data.tratamiento.mednombre }} {{ data.tratamiento.medapellido }}
        </p>
      </div>    
          ...
          <div class="row mt-4">
            <div class="col-sm-9">
              ...
              <p v-for="medicamento in data.medicamentos.data">
                ...
                <strong>Tipo Medicamento:</strong> {{ medicamento.tipo_medicamento}} <br>
...
export default {
  ...
  methods: {
    async guardar() {
      ...
      this.$toast('Recipe: R_'+ this.nuevoRecipe.id_recipe + ' Modificado Exitosamente!');
    },
