<template>
  <div>
    ...
    <button @click="modificar=false; listarArt();" type="button" class="btn btn-primary my-4">Articulos</button>
    <button @click="modificar=false; listarConsultas();" type="button" class="btn btn-primary my-4">Consultas</button>
